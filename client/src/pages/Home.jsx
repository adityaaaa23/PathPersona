    ...
    <div className="min-h-screen bg-brand-cream text-brand-charcoal font-sans pt-16">
      ...
      <div className="flex flex-col md:flex-row items-stretch border-b-2 border-brand-red min-h-[85vh]">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-start text-left bg-brand-cream px-8 py-16 md:px-16 md:py-24 border-b-2 md:border-b-0 md:border-r-2 border-brand-red">
          ...
          <h1 className="text-[clamp(2.5rem,5.5vw,4.5rem)] font-black leading-[1.05] mb-6 max-w-xl tracking-wider text-brand-charcoal uppercase">
            Learn the way your{" "}
            <span className="text-brand-red underline decoration-wavy underline-offset-8 decoration-2">
              mind
            </span>{" "}
            works
          </h1>
          ...
          <p className="text-sm md:text-base text-brand-charcoal/80 max-w-md leading-relaxed mb-10">
            Take a 10-question personality quiz, uncover your core cognitive
            learning type, and compile custom, AI-generated daily roadmaps for
            any skill.
          </p>
        ...
        <div className="w-full md:w-1/2 bg-brand-red text-brand-white flex flex-col justify-center items-start text-left px-8 py-16 md:px-16 md:py-24 relative overflow-hidden">
          ...
          <div className="border-l-2 border-brand-cream pl-6 py-2 max-w-md">
            <p className="text-sm text-brand-cream/90 leading-relaxed font-bold mb-4 uppercase tracking-wider">
              "Traditional learning models assume everyone digests information
              identically. We build learning plans shaped specifically to you."
            </p>
            <span className="text-xs font-black tracking-widest text-brand-cream/80">
              — AURALEARN METHOD
            </span>
          </div>
        </div>
      ...
      <div className="px-6 py-24 max-w-5xl mx-auto">
        <div className="text-left border-l-4 border-brand-red pl-6 mb-16">
          <p className="text-xs tracking-[0.2em] uppercase text-brand-red mb-2 font-black">
            The Core Pipeline
          </p>
          ...
          {[
            {
              step: "01",
              title: "Take the Quiz",
              desc: "Assess your processing style in 10 interactive questions.",
            },
            {
              step: "02",
              title: "Identify Your Style",
              desc: "Map your profile into visual, kinesthetic, social, or reading segments.",
            },
            {
              step: "03",
              title: "Build Roadmaps",
              desc: "Specify any technical skill and prompt AI to write daily learning flows.",
            },
          ].map((item) => (
            <div
              key={item.step}
              className="bg-brand-white border-2 border-brand-charcoal p-6 rounded-none swiss-shadow-red flex flex-col justify-between min-h-[200px] text-left"
            >
              <div className="flex justify-between items-start border-b border-brand-gray pb-4 mb-4">
                <p className="font-mono text-3xl font-black text-brand-red">
                  {item.step}
                </p>
                <div className="w-3 h-3 bg-brand-charcoal" />
              </div>
              <div>
                <h3 className="text-sm font-black tracking-wide text-brand-charcoal uppercase mb-2">
                  {item.title}
                </h3>
            ...
            {[
              {
                icon: "👁️",
                type: "Visual",
                desc: "Diagrams, spatial layouts, maps.",
              },
              {
                icon: "📚",
                type: "Reader",
                desc: "Documentation, text-based guides, books.",
              },
              {
                icon: "🛠️",
                type: "Kinesthetic",
                desc: "Interactive code blocks, projects, trials.",
              },
              {
                icon: "🤝",
                type: "Social",
                desc: "Communities, peer discussion, mentorship.",
              },
            ].map((item) => (
              <div
                key={item.type}
