    ...
    <div className='min-h-[85vh] w-full flex justify-center items-center px-4 py-8 pt-28 pb-16 bg-brand-cream font-sans'>
      <div className='w-full max-w-xl rounded-none bg-brand-white border-2 border-brand-charcoal shadow-2xl p-6 sm:p-10 flex flex-col gap-6 swiss-shadow'>
        ...
        <div className='text-center md:text-left'>
          <p className='text-xs font-black tracking-widest uppercase text-brand-red mb-1.5'>AI-Powered Roadmap</p>
          <h1 className='text-2xl sm:text-3xl font-black text-brand-charcoal uppercase tracking-wider mb-3'>What do you want to learn?</h1>
          <p className='text-xs md:text-sm text-brand-charcoal/80 leading-relaxed font-bold uppercase tracking-wider'>
            Enter any topic or technical skill. AuraLearn will dynamically query the AI and compile a day-by-day learning structure tuned exactly to your <span className='text-brand-red font-black underline decoration-2'>{user?.personalityType || 'personality'}</span> profile.
          </p>
        </div>

        <form className='flex flex-col gap-5 mt-2' onSubmit={(e) => generateRoadmap(e)}>

          <div className='flex flex-col gap-2 text-left'>
            <label className='text-[10px] font-black text-brand-charcoal uppercase tracking-widest ml-1'>Skill / Topic Name</label>
            <input
              type="text"
